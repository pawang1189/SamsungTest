...
public class UpcomingMoviesFragment extends Fragment {
    private static final String url_upcoming = "https://api.themoviedb.org/4/list/1?api_key=21e3c6c42909058f31c9860e55508ab4&page=2";
    ...
    private class GetMoviesAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String jsonStr = httpHandler.makeServiceCall(url_upcoming);
